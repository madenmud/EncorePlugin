package Plugins::RLClone::UPnPLib::Service;

#-----------------------------------------------------------------
# Net::Plugins::RLClone::UPnPLib::Service
#-----------------------------------------------------------------
...
use Plugins::RLClone::UPnPLib::ActionResponse;
use Plugins::RLClone::UPnPLib::QueryResponse;
...
sub new {
	my($class) = shift;
	my($this) = {
		$Plugins::RLClone::UPnPLib::Service::_DEVICE  => undef,
		$Plugins::RLClone::UPnPLib::Service::_DEVICE_DESCRIPTION => '',
	};
	bless $this, $class;
}
...
sub setdevice() {
	my($this) = shift;
	if (@_) {
		$this->{$Plugins::RLClone::UPnPLib::Service::_DEVICE} = $_[0];
	}
}

sub getdevice() {
	my($this) = shift;
	$this->{$Plugins::RLClone::UPnPLib::Service::_DEVICE};
}
...
sub setdevicedescription() {
	my($this) = shift;
	$this->{$Plugins::RLClone::UPnPLib::Service::_DEVICE_DESCRIPTION} = $_[0];
 }
...
sub getdevicedescription() {
	...
	if ($args{name}) {
		unless ($this->{$Plugins::RLClone::UPnPLib::Service::_DEVICE_DESCRIPTION} =~ m/<$args{name}>(.*)<\/$args{name}>/i) {
			return '';
		}
	 	return $1;
	}
	$this->{$Plugins::RLClone::UPnPLib::Service::_DEVICE_DESCRIPTION};
 }
...
sub getservicetype() {
	my($this) = shift;
	$this->getdevicedescription(name => $Plugins::RLClone::UPnPLib::Service::SERVICETYPE);
 }
...
sub getserviceid() {
	my($this) = shift;
	$this->getdevicedescription(name => $Plugins::RLClone::UPnPLib::Service::SERVICEID);
 }
...
sub getscpdurl() {
	my($this) = shift;
	$this->getdevicedescription(name => $Plugins::RLClone::UPnPLib::Service::SCPDURL);
 }
...
sub getcontrolurl() {
	my($this) = shift;
	$this->getdevicedescription(name => $Plugins::RLClone::UPnPLib::Service::CONTROLURL);
 }
...
sub geteventsuburl() {
	my($this) = shift;
	$this->getdevicedescription(name => $Plugins::RLClone::UPnPLib::Service::EVENTSUBURL);
 }
...
sub postaction() {
	...
	$action_res = Plugins::RLClone::UPnPLib::ActionResponse->new();
	...
	unless ($ctrl_url =~ m/http:\/\/([0-9a-z.]+)[:]*([0-9]*)\/(.*)/i) {
		...
		$post_res = Plugins::RLClone::UPnPLib::HTTPResponse->new();
...
sub postquery() {
	...
	$query_res = Plugins::RLClone::UPnPLib::QueryResponse->new();
...
Plugins::RLClone::UPnPLib::Service - Perl extension for UPnP.
...
Post a action control to the device, and return L<Plugins::RLClone::UPnPLib::ActionResponse>.
...
Post a query control to the device, and return L<Plugins::RLClone::UPnPLib::QueryResponse>.

=back

=head1 SEE ALSO

L<Plugins::RLClone::UPnPLib::ActionResponse>

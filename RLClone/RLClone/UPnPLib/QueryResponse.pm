package Plugins::RLClone::UPnPLib::QueryResponse;

#-----------------------------------------------------------------
# Plugins::RLClone::UPnPLib::QueryResponse
#-----------------------------------------------------------------
...
sub new {
	my($class) = shift;
	my($this) = {
		$Plugins::RLClone::UPnPLib::QueryResponse::_HTTP_RESPONSE => undef,
	};
	bless $this, $class;
}
...
sub sethttpresponse() {
	my($this) = shift;
	$this->{$Plugins::RLClone::UPnPLib::QueryResponse::_HTTP_RESPONSE} = $_[0];
 }

sub gethttpresponse() {
	my($this) = shift;
	$this->{$Plugins::RLClone::UPnPLib::QueryResponse::_HTTP_RESPONSE};
 }
...
Plugins::RLClone::UPnPLib::QueryResponse - Perl extension for UPnP.

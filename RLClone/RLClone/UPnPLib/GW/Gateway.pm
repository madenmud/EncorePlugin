package Plugins::RLClone::UPnPLib::GW::Gateway;

#-----------------------------------------------------------------
# Plugins::RLClone::UPnPLib::GW::Gateway
#-----------------------------------------------------------------
...
sub new {
	my($class) = shift;
	my($this) = {
		$Plugins::RLClone::UPnPLib::GW::Gateway::_DEVICE => undef,
	};
	bless $this, $class;
}
...
sub setdevice() {
	my($this) = shift;
	if (@_) {
		$this->{$Plugins::RLClone::UPnPLib::GW::Gateway::_DEVICE} = $_[0];
	}
}

sub getdevice() {
	my($this) = shift;
	$this->{$Plugins::RLClone::UPnPLib::GW::Gateway::_DEVICE};
}
...
sub getexternalipaddress {
	...
	$dev = $this->getdevice();
	$wanipcon_service = $dev->getservicebyname($Plugins::RLClone::UPnPLib::GW::Gateway::WANIPCONNECTION_SERVICE_TYPE);
...
Plugins::RLClone::UPnPLib::GW::Gateway - Perl extension for UPnP.

=head1 SYNOPSIS

	use Plugins::RLClone::UPnPLib::ControlPoint;
	use Plugins::RLClone::UPnPLib::GW::Gateway;
	...
	foreach $dev (@dev_list) {
		...
		my $gwdev = Plugins::RLClone::UPnPLib::GW::Gateway->new();
		$gwdev->setdevice($dev);
...
=item B<new> - create new Plugins::RLClone::UPnPLib::GW::Gateway.

    $mservier = Plugins::RLClone::UPnPLib::GW::Gateway();
...
L<Plugins::RLClone::UPnPLib::GW::Content>

L<Plugins::RLClone::UPnPLib::GW::Item>

L<Plugins::RLClone::UPnPLib::GW::Container>

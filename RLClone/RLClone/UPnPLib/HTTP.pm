package Plugins::RLClone::UPnPLib::HTTP;

#-----------------------------------------------------------------
# Plugins::RLClone::UPnPLib::HTTP
#-----------------------------------------------------------------
...
REQUEST_HEADER
	...
	$res = Plugins::RLClone::UPnPLib::HTTPResponse->new();
...
sub postsoap {
	...
	$this->post($post_addr, $post_port, $Plugins::RLClone::UPnPLib::HTTP::POST, $path, \%soap_header, $action_content);
}
...
Plugins::RLClone::UPnPLib::HTTP - Perl extension for UPnP.
